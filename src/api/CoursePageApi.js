...
export const fetchMyHomework = async (userNum, courseId) => {
  try {
    const response = await axios.get(
      "http://localhost:8000/student/course/homework",
      {
        params: {
    ...
    response.data.homeworkList.forEach((homework) => {
      if (homework.submissionDeadline) {
        homework.submissionDeadline = formatSubmissionDeadline(
          homework.submissionDeadline
        );
      }
...
export const fetchHomeworkAttachments = async (courseId, homeworkId) => {
  try {
    const response = await axios.get(
      "http://localhost:8000/student/course/homework/attachments",
      {
        params: {
          courseId: Number(courseId),
...
export const submitHomework = async (
  ...
  try {
    ...
    const response = await axios.post(
      "http://localhost:8000/student/course/homework/upload",
      formData,
      {
        headers: {
...
export const getCourseNotification = async (courseId) => {
  try {
    const response = await axios.get(
      "http://localhost:8000/course/notification",
      {
        params: {
          courseId: Number(courseId),
        },
...
export const getCourseDiscussion = async (courseId) => {
  try {
    const response = await axios.get(
      "http://localhost:8000/course/discussion",
      {
        params: {
          courseId: Number(courseId),
        },
...
export const getCoursePostDetial = async (postId) => {
  try {
    const response = await axios.get(
      "http://localhost:8000/course/discussionById",
      {
        params: {
...
export const submitPostComment = async (postId, content, studentNum) => {
  try {
    const response = await axios.post(
      "http://localhost:8000/student/post/setComment",
      null,
      {
        params: {
          postId: Number(postId),
...
// 发布评论
export const submitPostCommentByTeacher = async (
  postId,
  content,
  studentNum
) => {
  try {
    const response = await axios.post(
      "http://localhost:8000/teacher/post/setComment",
      null,
      {
        params: {
          postId: Number(postId),
...
export const downLoadCourseResource = async (resourceId) => {
  try {
    const response = await axios.get(
      "http://localhost:8000/course/downLoadResource",
      {
        params: {
...
export const deleteCourseResource = async (resourceId) => {
  return await axios.delete(
    `http://localhost:8000/teacher/course/deleteResource/${resourceId}`
  ).data;
};
...
export const getCourseWorkSetList = async (courseId) => {
  try {
    const response = await axios.get(
      "http://localhost:8000/course/resource/workSet",
      {
        params: {
          courseId: Number(courseId),
        },
...
export const sendNotification = async (
  ...
  try {
    const response = await axios.post(
      "http://localhost:8000/teacher/sendNotification",
      null,
      {
        params: {
          title: title,
...
export const submitNewDiscussionPost = async (
  courseID,
  newPost,
  studentNum
) => {
  ...
  const response = await axios.post(
    "http://localhost:8000/student/setPost",
    null,
    {
      params: {
        courseId: Number(courseID),
...
export const submitNewDiscussionPostByTeacher = async (
  courseID,
  newPost,
  teacherNum
) => {
  ...
  const encodedContent = encodeURIComponent(newPost.content); // 编码 content
  const response = await axios.post(
    "http://localhost:8000/teacher/setPost",
    null,
    {
      params: {
        courseId: Number(courseID),
...
export const setTeacherInfo = async (courseId, phoneNum, content) => {
  try {
    const response = await axios.post(
      "http://localhost:8000/course/setTeacherInfo",
      null,
      {
        params: {
...
export const deletePostByTeacher = async (postId) => {
  return await axios.delete(
    `http://localhost:8000/teacher/course/deletePost/${postId}`
  ).data;
};
...
export const getStudentHomeworkList = async (courseId, homeworkNum) => {
  const response = await axios.get(
    "http://localhost:8000/teacher/course/homework/homeworkDetailList",
    {
      params: {
...
export const getStudentHomeworkDetial = async (homeworkId) => {
  const response = await axios.get(
    "http://localhost:8000/teacher/course/homework/homeworkCorrect",
    {
      params: {
...
export const submitGradeByTeacher = async (homeworkId, grade) => {
  await axios.post(
    "http://localhost:8000/teacher/course/homework/submitGrade",
    null,
    {
      params: {
...
export const getHomeworkStatics = async (courseId, homeworkNum) => {
  const response = await axios.get(
    "http://localhost:8000/teacher/course/homework/static",
    {
      params: {
        courseId: Number(courseId),
        homeworkNum: homeworkNum,
